...
},{"../../cfg":6,"../../packet":11,"buffer":2}],9:[function(require,module,exports){
"use strict";
...
window.addEventListener("keydown", function (e) {
  ...
  switch (e.keyCode) {
    case 32:
      packet = (0, _packet.encodePacket)([_packet.PID.JUMP]);
    ...
    case 38:
    case 40:
      packet = (0, _packet.encodePacket)([_packet.PID.MOVE, e.keyCode]);
      client.network.send(packet);
      break;
  };
});
...
function decodePacket(buffer) {
  var type = PID[buffer[0] << 0];
  var kind = PACKET[type].kind;
  var decoded = null;
  switch (kind) {
    case TYPE.UINT8:
      ...
      break;
    case TYPE.UINT16:
      var bytes = Uint16Array.BYTES_PER_ELEMENT;
      var length = buffer.length / bytes << 0 || 1;
